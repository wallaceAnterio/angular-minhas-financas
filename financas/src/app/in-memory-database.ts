...
export class InMemoryDatabase implements InMemoryDbService {
  ...
  createDb() {
    ...
    // Entradas (fake)
    const entries: Entry[] = [
      { id: 1, name: 'Gás de cozinha', categoryId: categories[0].id, category: categories[0], paid: true, date: "14/10/2019", amount: "70,80", type: "expense", desciption: "Qualquer descrição para essa despesa"} as Entry,
